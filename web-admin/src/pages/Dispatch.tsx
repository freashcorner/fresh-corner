...
export default function Dispatch() {
  ...
  return (
    <div className="p-6">
      <SectionHeader title="ডিসপ্যাচ পোর্টাল">
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-[#2D2D2D] rounded-xl w-full max-w-sm border border-white/10">
            ...
            <form onSubmit={handleAssign} className="p-5 space-y-3">
              ...
              <input placeholder="আনুমানিক সময়" value={form.estimatedTime} onChange={(e) => setForm({ ...form, estimatedTime: e.target.value })} className="w-full bg-[#3C3C3C] border border-white/10 rounded-lg px-3 py-2 text-sm text-white outline-none focus:border-yaru-orange font-bangla" />
